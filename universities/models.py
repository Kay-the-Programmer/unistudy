...
class Faculty(models.Model):
    ...
    class Meta:
        constraints = [
            UniqueConstraint(fields=['university', 'slug'], name='unique_faculty_slug_per_university'),
            UniqueConstraint(fields=['university', 'name'], name='unique_faculty_name_per_university'),
        ]
...
class Course(models.Model):
    ...
    year_offered = models.PositiveIntegerField(help_text="Year the course is typically offered, e.g., 1, 2, 3, 4")
